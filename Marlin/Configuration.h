...
// For Tevo Tarantual i3 BOARD_RAMPS_13_EFB = 33 (AKA MKS Base v1.2)
#ifndef MOTHERBOARD
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,1600,97.0874} //custom for Tarantula
...
#define DEFAULT_MAX_FEEDRATE          { 250, 250, 1.5, 50 } //custom for Tarantula
...
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 100, 10000 } //custom for Tarantula
...
//    O-- FRONT --+
//  (0,0)
#define X_PROBE_OFFSET_FROM_EXTRUDER 38.5  // X offset: -left  +right  [of the nozzle]
...
#define MANUAL_Z_HOME_POS 0 // Distance between the nozzle and printbed after homing
